        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="mt-4 md:mt-0 md:ml-24">
                ...
                @if(count($movie['videos']['results']) > 0)
                    <div class="mt-12">
                        <a href="https://youtu.be/{{$movie['videos']['results'][0]['key']}}"
                           class="flex inline-flex items-center bg-orange-500 text-gray-900 round font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach($movie['images']['backdrops'] as $image)
                    @if($loop->index < 9)
                        <div class="mt-8">
                            <a href="#">
                                <img src="{{'https://image.tmdb.org/t/p/w500/'.$image['file_path']}}" alt="{{$movie['title']. ' (Resim '.($loop->index+1).'/9)'}}"
                                     class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @endif
